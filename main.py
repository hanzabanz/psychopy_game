                ...
                for num in range(num_reps):
                    ...
                    if QUIT_EXP is False:
                        ...
                        if status != -1:
                            ...
                            if trial_type == 0:
                                status = motor.trial(clock, window, shapes, keyboard, mouse, text_color, centered, wait_time, warning_time, exp)
                            elif trial_type == 1:
                                status = speech.trial(clock, window, shapes, keyboard, mouse, text_color, wait_time, warning_time, exp)
                            elif trial_type == 2:
                                print "here"
                                status = eye.trial(io, clock, window, shapes, keyboard, mouse, tracker, text_color, centered, wait_time, warning_time, exp)
                ...
                if QUIT_EXP is False:
                    ...
                    if status != -1:
                        ...
                        if trial_type == 0:
                            ...
                            status = eye.trial(io, clock, window, shapes, keyboard, mouse, tracker, text_color, wait_time, warning_time, exp)
